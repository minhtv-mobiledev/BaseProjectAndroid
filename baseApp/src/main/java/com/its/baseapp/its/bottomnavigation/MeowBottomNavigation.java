...
public final class MeowBottomNavigation extends FrameLayout {
    ...
    public MeowBottomNavigation(Context context) {
        ...
        this.startCircleColor = Color.parseColor("#5efc82");
        this.centerCircleColor = Color.parseColor("#005EFC82");
        this.endCircleColor = Color.parseColor("#FFBB86FC");
        ...
        this.heightCell = Utils.dip(this.getContext(), 68);
    ...
    private void setAttributeFromXml(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            this.setCircleColor(a.getColor(R.styleable.MeowBottomNavigation_mbn_startCircleColor, this.startCircleColor),
                    a.getColor(R.styleable.MeowBottomNavigation_mbn_centerCircleColor, this.centerCircleColor), a.getColor(R.styleable.MeowBottomNavigation_mbn_endCircleColor, this.endCircleColor));
            this.setDuration(a.getInt(R.styleable.MeowBottomNavigation_mbn_valueDurationColor, this.valueDuration));
    ...
    public final void add(final Model model) {
        ...
        cell.setCircleColor(this.startCircleColor, this.centerCircleColor, this.endCircleColor);
        cell.setValueDuration(this.valueDuration);
    ...
    private void updateAllIfAllowDraw() {
        if (this.allowDraw) {
            ...
            for (Object element$iv : $this$forEach$iv) {
                ...
                it.setCircleColor(this.startCircleColor, this.centerCircleColor, this.endCircleColor);
                it.setValueDuration(this.valueDuration);
